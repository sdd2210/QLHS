...
let AudioProcessor = AudioProcessor_1 = class AudioProcessor {
    ...
    handleTranscode(job) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.emailService.send(to, context, title, template, isCC);
        });
    }
};
__decorate([
...
AudioProcessor = AudioProcessor_1 = __decorate([
    (0, bull_1.Processor)({ name: 'mailer', scope: common_1.Scope.REQUEST }),
    __metadata("design:paramtypes", [mail_service_1.EmailService])
], AudioProcessor);
exports.AudioProcessor = AudioProcessor;
//# sourceMappingURL=mail.processer.js.map