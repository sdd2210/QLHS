...
let LessonService = class LessonService {
    constructor(tLessonModel) {
        this.tLessonModel = tLessonModel;
    }
    ...
    getAll(searchstring, class_id, status, rowsPerpage, currentPage) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield this.tLessonModel.aggregate(query);
                return data;
            }
            catch (error) {
                console.log(error);
...
LessonService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(lesson_schema_1.T_Lesson.name)),
